...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href='{{asset("AdminLTE-2.4/bower_components/morris.js/morris.css")}}'>
  <!-- jvectormap -->
  <link rel="stylesheet" href='{{asset("AdminLTE-2.4/bower_components/jvectormap/jquery-jvectormap.css")}}'>
  <!-- Date Picker -->
  <link rel="stylesheet" href='{{asset("AdminLTE-2.4/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css")}}'>
  <!-- Daterange picker -->
  <link rel="stylesheet" href='{{asset("AdminLTE-2.4/bower_components/bootstrap-daterangepicker/daterangepicker.css")}}'>
...
<!-- jQuery UI 1.11.4 -->
<script src='{{asset("AdminLTE-2.4/bower_components/jquery-ui/jquery-ui.min.js")}}'></script>
...
<!-- Morris.js charts -->
<script src='{{asset("AdminLTE-2.4/bower_components/raphael/raphael.min.js")}}'></script>
<script src='{{asset("AdminLTE-2.4/bower_components/morris.js/morris.min.js")}}'></script>
<!-- Sparkline -->
<script src='{{asset("AdminLTE-2.4/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js")}}'></script>
<!-- jvectormap -->
<script src='{{asset("AdminLTE-2.4/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js")}}'></script>
<script src='{{asset("AdminLTE-2.4/plugins/jvectormap/jquery-jvectormap-world-mill-en.js")}}'></script>
<!-- jQuery Knob Chart -->
<script src='{{asset("AdminLTE-2.4/bower_components/jquery-knob/dist/jquery.knob.min.js")}}'></script>
<!-- daterangepicker -->
<script src='{{asset("AdminLTE-2.4/bower_components/moment/min/moment.min.js")}}'></script>
<script src='{{asset("AdminLTE-2.4/bower_components/bootstrap-daterangepicker/daterangepicker.js")}}'></script>
<!-- datepicker -->
<script src='{{asset("AdminLTE-2.4/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js")}}'></script>
<!-- Bootstrap WYSIHTML5 -->
<script src='{{asset("AdminLTE-2.4/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js")}}'></script>
<!-- Slimscroll -->
